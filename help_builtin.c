...
void help_all(void)
{
	char *msg = "Shell\nShell commands are defined here.\n";

	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "Type 'help' to see the list of helps.\nType 'help name' to find ";
	write(STDOUT_FILENO, msg, _strlen(msg));
...
void help_cd(void)
{
	char *msg = "cd: cd [DIRECTORY]\n\tThis changes the current directory of the";
...
void help_exit(void)
{
	...
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = " If no argument is [provided], the command is interpreted as";
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = " exit 0.\n";
	write(STDOUT_FILENO, msg, _strlen(msg));
}
